...
const submitForm = async () => {
  try {
    ...
    form.value.deviceId = "";
    (form.value.companyName = ""), (form.value.orderId = "");
    (form.value.purchaseDate = ""), (form.value.invoicePhotos = "");
  } catch (error) {
    const errorMessage =
                ...
                >
                  ...
                  <p v-else>
                    <i
                      ...
                      style="color: #2239c3cc; font-size: 40px"
                    ></i>
                  </p>
                  ...
                  <p
                    v-if="form.invoicePhotos"
                    style="font-size: 14px; color: #555"
                  >
                    {{ form.invoicePhotos.name }}
                  </p>
                </label>
