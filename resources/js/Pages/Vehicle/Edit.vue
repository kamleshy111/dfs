            ...
            <div class="form-container shadow from-main-design">
                <form @submit.prevent="submitForm">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <select class="form-control" v-model="form.customer_id" @change="onCustomerChange">
                                ...
                                <option v-for="customer in customers" v-bind:value="customer.id">{{ customer.first_name
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <input type="text" v-model="form.vehicle_register_number" class="form-control"
                                id="vehicle_register_number" placeholder="" />
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <Datepicker v-model="form.installation_date" class="form-control" id="installation_date"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <Datepicker v-model="form.start_date" class="form-control" id="start_date"
                                :format="dateFormat" placeholder="" />
